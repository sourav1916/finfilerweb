...
const LogoutModal = ({ isOpen, onClose, onConfirm, loading }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative z-10 w-full max-w-sm mx-4 bg-primary border border-border rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between px-5 pt-5 pb-4">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-base font-semibold text-primary-foreground">Sign out?</h3>
          </div>
          <button
            onClick={handleClose}
            disabled={loading}
        ...
        <div className="px-5 pb-4 space-y-4">
          <p className="text-sm text-secondary-foreground leading-relaxed">
            You'll be signed out of your current session. Any unsaved changes will be lost.
          </p>
          ...
          >
            <div className="text-left">
              <p className="text-sm font-medium text-primary-foreground">Sign out of all devices</p>
              <p className="text-xs text-secondary-foreground mt-0.5">
                Terminates every active session, including mobile and other browsers.
              </p>
            </div>
        ...
        <div className="flex items-center gap-2 px-5 py-4 border-t border-border bg-secondary/40">
          ...
          >
            {loading
              ...
              : logoutAll ? 'Sign out everywhere' : 'Sign out'
            }
          </button>
        </div>
      </div>
              ...
              <div className="relative">
                ...
                {openDropdown && (
                  <>
                    ...
                    <div
                      className="absolute right-0 mt-2 w-60 rounded-2xl shadow-2xl border border-border overflow-hidden z-50"
                      style={{
                        background: 'linear-gradient(135deg, var(--color-nav) 0%, color-mix(in srgb, var(--color-nav) 92%, #6366f1) 100%)',
